...
window.the_main_function_for_the_example_1 = function() {
	...
	var btn = new window.raudrohi.widgets.g1.button_t1(s_our_widget_html_id,
		s_button_label);
	...
	btn.evh_button_pushed_impl=function(){
		...
		window.raudrohi.base.set_innerHTML('greeting_div','<b>Hello World!</b>');
...
window.onload = function() {
	...
	// specific JavaScript code into a single file, because then one can
	...
	// broadens the JavaScript compressor's ability
	// to apply global optimizations.
