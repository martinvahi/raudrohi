...
//-------------------------------------------------------------------------
// The window.raudrohi.widgets.g1.pileofmethods_t1 is not a widget itself, but
// it is a field that every widget in the namespace
// window.raudrohi.widgets.g1 has.
//
// The code of the window.raudrohi.widgets.g1.pileofmethods_t1
...
//       a clear distinction.
//
window.raudrohi.widgets.g1.pileofmethods_t1 =
function (instance_public, s_phonenumber_prefix, s_html_id) {
    ...
    try {
        ...
        // are encapsulated to the window.raudrohi.widgets.g1.pileofmethods_t1.
        ...
        try {
            ...
            new window.raudrohi.lang.startup_shutdown_handler(instance_public_);
            ...
            new window.raudrohi.base.state_switcher_t1();
            ...
            instance_public_.is_running = function () {
                try {
                    ...
                    window.raudrohi.tmg('31ff4f5f-c486-4a09-940f-13202011abd7', err);
                } // catch
            }
            ...
            function (s_field_name_in_parent) {
                try {
                    if (raudrohi_settings_debug_JavaScript === true) {
                        window.raudrohi.base.assert_isString(s_field_name_in_parent,
                    ...
                    window.raudrohi.tmg('fd29ba56-3425-4774-a30f-13202011abd7', err);
                } // catch
            ...
            instance_public_.s_get_field_name_in_parent = function () {
                try {
                    ...
                    window.raudrohi.tmg('57c60953-05fb-43ba-a10f-13202011abd7', err);
                } // catch
            ...
            prc_.bitfield_ = new window.raudrohi.base.bitfield_htbased();
            ...
            // also avoid writing the window.raudrohi.base.normalize_linebreaks
            ...
            instance_public_.phone = new window.raudrohi.lang.comm.phone(
                s_phonenumber_prefix + s_html_id);
        } catch (err) {
            window.raudrohi.tmg('e4a4214a-a287-48dd-920f-13202011abd7', err);
        } // catch

        var ob_critical_section_impl_ = new window.raudrohi.critical_section_t1();
            ...
            try {
                ...
                for (i = 0; i < len; i++) {
                    ...
                    try {
                        ...
                        window.raudrohi.tmg('a5c8f9ca-586d-4a1f-860f-13202011abd7',
                            err);
                    } // catch
                } // for
            }
            catch (err) {
                window.raudrohi.tmg('2c66d032-5f0a-4fdc-b4fe-13202011abd7', err);
            } // catch
        ...
        prc_.assert_stateExists = function (state_name) {
            try {
                window.raudrohi.base.assert_isString(state_name, 'state_name',
                    '59e40663-ed92-4d68-a2fe-13202011abd7');
                if (instance_public_.state_switcher_.state_exists(state_name) !==
                    true) {
                    window.raudrohi.tmg('332a9052-7b7d-4e77-95fe-13202011abd7',
                        'State ' + state_name +
                        ' does not exist in the local state_switcher.');
                } // if
            } catch (err) {
                window.raudrohi.tmg('84736896-96c6-4e17-88fe-13202011abd7', err);
            } // catch
        ...
        instance_public_.hide = function (true_if_update_DOM) {
            try {
                if (raudrohi_settings_debug_JavaScript === true) {
                    window.raudrohi.base.assert_isBoolean(true_if_update_DOM,
                        'true_if_update_DOM',
                ...
                instance_public_.only_for_raudrohi_core_developers.content_from_GUI_2_vars_recursive();
                window.raudrohi.widgets.g1.sys.hide_or_unhide_t2(prc_.ar_widgets_,
                    false, true_if_update_DOM,
                    prc_.ht_widgets_conserved_states_);
                window.raudrohi.adapter.editStyle(prc_.container_id_, 'visibility',
                    'hidden');
                ...
                window.raudrohi.tmg('1922c355-82a8-480e-97fe-13202011abd7',
        ...
        instance_public_.unhide = function () {
            try {
                ...
                window.raudrohi.adapter.editStyle(prc_.container_id_,
                    'visibility', 'visible');
                ...
                if (prc_.self_is_hidden_ === false) {
                    ...
                    if (0 < i_pfawl) {
                        ...
                        try {
                            ...
                            window.raudrohi.tmg('c39e4612-3bf4-45b8-92fe-13202011abd7',
                                err);
                        } // catch
                    } // if
                } // if
                ...
                try {
                    ...
                    window.raudrohi.tmg('0da66e15-92a2-457d-95fe-13202011abd7', err);
                } // catch
                try {
                    window.raudrohi.widgets.g1.sys.hide_or_unhide_t2(prc_.ar_widgets_,
                        true, true, prc_.ht_widgets_conserved_states_);
                } catch (err0) {
                    window.raudrohi.tmg('55293756-1ca5-4d12-93fe-13202011abd7', err0);
                } // catch
                prc_.self_is_hidden_ = false;
            } catch (err) {
                window.raudrohi.tmg('488a0865-f0ce-416f-91fe-13202011abd7',
        ...
        instance_public_.get_widget_state = function () {
            try {
                var widget_state = new window.raudrohi.base.widget_state_bitfield();
                ...
                window.raudrohi.tmg('18866a44-fd5d-4524-84ee-13202011abd7',
                    'prc_.container_id_==' + prc_.container_id_ + '  ' + err);
            } // catch
        } // get_widget_state
        ...
        instance_public_.get_widget_html_id = function () {
            try {
                ...
                window.raudrohi.tmg('1b7dbc4b-ccbf-45e7-a3ee-13202011abd7',
                    'prc_.container_id_==' + prc_.container_id_ + '  ' + err);
            } // catch
        } // get_widget_html_id
        ...
        function (config_field_name, config_field_value) {
            try {
                if (raudrohi_settings_debug_JavaScript === true) {
                    window.raudrohi.base.assert_isString(config_field_name,
                        'config_field_name',
                        '3be07233-2567-4fbd-a4ee-13202011abd7');
                    window.raudrohi.base.assert_isNotnull(config_field_value,
                        'config_field_value',
                ...
                window.raudrohi.tmg('5cebbd55-0169-46fb-a3ee-13202011abd7',
                    'prc_.container_id_==' + prc_.container_id_ + '  ' + err);
            } // catch
        } // set_config
            ...
            try {
                if (raudrohi_settings_debug_JavaScript === true) {
                    if (an_instance_or_null !== null) {
                        window.raudrohi.base.assert_isObject(an_instance_or_null,
                            'an_instance_or_null',
                ...
                window.raudrohi.tmg('48214e64-8a8f-476f-a2ee-13202011abd7', err);
            } // catch
            ...
            try {
                ...
                for (i = 0; i < len; i++) {
                    ...
                    try {
                        ...
                        window.raudrohi.tmg('5ab3a87a-d756-4964-a5ee-13202011abd7',
                            err);
                    } // catch
                } // for
                prc_.customizable.optional.set_readonly_suffixhook(b_true_if_readonly);
            } catch (err) {
                window.raudrohi.tmg('9c196fc9-4f99-487b-a7de-13202011abd7', err);
            } // catch
        } // set_readonly
        ...
        instance_public_.reset_container_id = function (new_container_id) {
            try {
                if (raudrohi_settings_debug_JavaScript === true) {
                    window.raudrohi.base.assert_isString(new_container_id,
                        'new_container_id',
                ...
                window.raudrohi.tmg('53da4980-d0c5-45e8-b1de-13202011abd7', err);
            } // catch
        ...
        instance_public_.content_is_set = function () {
            try {
                ...
                window.raudrohi.tmg('2b732b01-d1bc-4c22-b1de-13202011abd7', err);
            } // catch
        } // content_is_set
        ...
        function (key_number_as_string, event_handler_func) {
            try {
                ...
                if (!prc_.keylisteners_unit_inited_) {
                    ...
                    new window.raudrohi.widgets.g1.sys.keylisteners_unit(instance_public_);
                ...
                window.raudrohi.tmg('92e93131-d7da-4d4d-82de-13202011abd7', err);
            } // catch
        } // set_keylistener
        ...
        instance_public_.remove_keylistener = function (key_number) {
            try {
                if (raudrohi_settings_debug_JavaScript === true) {
                    window.raudrohi.base.assert_isNumber(key_number, 'key_number',
                ...
                window.raudrohi.tmg('e147b905-d4ff-4138-b1ce-13202011abd7', err);
            } // catch
        } // remove_keylistener
        ...
        instance_public_.remove_all_keylisteners = function () {
            try {
                ...
                window.raudrohi.tmg('3af09617-2198-4324-a3ce-13202011abd7', err);
            } // catch
        ...
        // is meant only for the window.raudrohi.lang.startup_shutdown_handler
        ...
        function () {
            try {
                ...
                if (prc_.widgets_created_ !== true) {
                    ...
                    window.raudrohi.widgets.g1.sys.startup_t1(prc_.ar_widgets_,
                ...
                window.raudrohi.tmg('178ca8e3-a8bd-4823-9ace-13202011abd7', err);
            } // catch
        } // instance_public_.only_for_raudrohi_core_developers.widget_startup_sequence
        ...
        instance_public_.startup_sequence_init = function () {
            try {
                ...
                window.raudrohi.tmg('8b4f6133-60a6-4934-83ce-13202011abd7', err);
            } // catch
        ...
        function (alignment_as_a_cardinal_point) {
            try {
                ...
                window.raudrohi.tmg('1a24c247-82d6-4102-b5ce-13202011abd7', err);
            } // catch
        } // instance_public_.set_alignment
        ...
        function () {
            try {
                ...
                window.raudrohi.widgets.g1.sys.change_state_2(prc_.ar_widgets_,
                    'zero');
                instance_public_.hide(true);
                prc_.customizable.optional.shutdown_hook();
                window.raudrohi.widgets.g1.sys.shutdown_t1(prc_.ar_widgets_);
                ...
                window.raudrohi.widgets.g1.sys.close_microsessions_t1(instance_public_.only_for_raudrohi_core_developers.ht_microsessions_);
                prc_.startup_shutdown_handler_.hook_shutdown_complete();
            } catch (err) {
                window.raudrohi.tmg('8b2bcf44-408c-4fa3-93ce-13202011abd7', err);
            } // catch
        } // instance_public_.only_for_raudrohi_core_developers.widget_shutdown_sequence
        ...
        instance_public_.shutdown_sequence_init = function () {
            try {
                ...
                window.raudrohi.tmg('88ef9849-25cc-4bfa-b5ce-13202011abd7', err);
            } // catch
        ...
        function (ht_wrapper) {
            if (raudrohi_settings_debug_JavaScript === true) {
                window.raudrohi.tmg('ed05fd2a-4285-4321-95be-13202011abd7',
        ...
        instance_public_.thrjr_.display_message_thrjr = function (ht_wrapper) {
            ...
            try {
                ...
                window.raudrohi.base.assert_isString(msg, 'msg',
                ...
                window.raudrohi.tmg('4d4fecd2-ef72-4ce5-acbe-13202011abd7', err);
            } // catch
        ...
        function gahter_inner_widgets_states() {
            try {
                ...
                window.raudrohi.tmg('49f85a73-894c-4a7f-92be-13202011abd7',
                    'prc_.container_id_==' + prc_.container_id_ + '  ' + err);
            } // catch
        } // gahter_inner_widgets_states
            ...
            try {
                if (raudrohi_settings_debug_JavaScript === true) {
                    ...
                    if (dbg_widget_state.is_in_state_hidden === false) {
                        if (prc_.self_is_hidden_ !== false) {
                            window.raudrohi.tmg('84716a4b-8e27-49b3-b3be-13202011abd7',
                ...
                window.raudrohi.tmg('0cecad1e-ddea-495e-94ae-13202011abd7',
                    'prc_.container_id_==' + prc_.container_id_ + '  ' + err);
            } // catch
        ...
        prc_.unregister_all_subwidgets = function () {
            try {
                ...
                window.raudrohi.tmg('030a1127-4400-4e58-92ae-13202011abd7', err);
            } // catch
        ...
        function (a_widget, true_if_update_DOM) {
            try {
                ...
                if (raudrohi_settings_debug_JavaScript === true) {
                    window.raudrohi.base.assert_isNotnull(a_widget, 'a_widget',
                    ...
                    if (prc_.ht_widgets_conserved_states_.containsKey(phn) ===
                        false) {
                        window.raudrohi.tmg('5200db3d-6394-45ae-84ae-13202011abd7',
                ...
                window.raudrohi.tmg('eae6c933-8568-4345-a2ae-13202011abd7',
                    'prc_.container_id_==' + prc_.container_id_ + '  ' + err);
            } // catch
        } // prc_.mark_elemwidget_to_be_hidden
            ...
            try {
                ...
                if (raudrohi_settings_debug_JavaScript === true) {
                    ...
                    if (!prc_.ht_widgets_conserved_states_default_.containsKey(phn)) {
                        window.raudrohi.tmg('3e8dca53-ef08-4c3e-859e-13202011abd7',
                            'prc_.ht_widgets_conserved_states_ does not contain ' +
                            'a key of ' + phn);
                    } // if
                } // if
                ...
                if (raudrohi_settings_debug_JavaScript === true) {
                    if (!prc_.ht_widgets_conserved_states_.containsKey(phn)) {
                        window.raudrohi.tmg('58133229-c504-445e-a59e-13202011abd7',
                            'prc_.ht_widgets_conserved_states_ does not contain ' +
                            'a key of ' + phn);
                    } // if
                } // if
                ...
                window.raudrohi.tmg('7b3ecd2c-8dfe-45a7-919e-13202011abd7',
                    'prc_.container_id_==' + prc_.container_id_ + '  ' + err);
            } // catch
        ...
        function init_ht_widgets_conserved_states_if_necceccary() {
            try {
                ...
                window.raudrohi.tmg('399294f3-58d2-4bfe-839e-13202011abd7', err);
            } // catch
        } // init_ht_widgets_conserved_states_if_necceccary
        ...
        this.display_message_t1 = function (message_text) {
            try {
                if (prc_.widgets_created_ === true) {
                    ...
                    if (raudrohi_settings_debug_JavaScript === true) {
                        window.raudrohi.tmg('b7330ce8-b223-461e-879e-13202011abd7',
                            'display_message got called before the ' +
                            'message displaying widget is instantiated.');
                    } // if
                } // else
            } catch (err) {
                window.raudrohi.tmg('434c2e98-20da-41a3-b39e-13202011abd7', err);
            } // catch
        } // display_message_t1
        ...
        this.display_message_t2 = function (message_text) {
            try {
                ...
                window.raudrohi.tmg('4e5c7425-1382-44ae-a29e-13202011abd7', err);
            } // catch
        } // display_message_t2

        this.display_message_t3 = function (message_text) {
            try {
                window.raudrohi.base.assert_isString(message_text, 'message_text',
                ...
                window.raudrohi.tmg('00887741-4886-465d-928e-13202011abd7', err);
            } // catch
        } // display_message_t3
        ...
        function (ht_wrapper) {
            try {
                ...
                var microsession_name = 'microsession_name_' +
                                        instance_public_.phone.get_phone_number() +
                                        '_' + window.raudrohi.base.generate_id();
                instance_public_.only_for_raudrohi_core_developers.ht_microsessions_cnt_++;
                ...
                window.raudrohi.tmg('099af15c-b894-4f5b-848e-13202011abd7', err);
            } // catch
        } // instance_public_.only_for_raudrohi_core_developers.microsession_set_id
        ...
        function (destination_command, return_command) {
            try {
                if (raudrohi_settings_debug_JavaScript === true) {
                    window.raudrohi.base.assert_isString(return_command,
                        'return_command',
                        'a8057535-a8a4-4ec7-958e-13202011abd7');
                    window.raudrohi.base.assert_isString(destination_command,
                        'destination_command',
                        '2c996d1a-f4ae-4a43-838e-13202011abd7');
                } // if
                var ht_wrapper = window.raudrohi.base.pool_of_hashtables.get_empty_hashtable();
                ...
                ht_wrapper.put('data', ''); // Otherwise window.raudrohi.lang.ht2ProgFTE(ht_data));
                return ht_wrapper;
            } catch (err) {
                window.raudrohi.tmg('230cd852-7ffe-431e-a28e-13202011abd7', err);
            } // catch
        } // instance_public_.only_for_raudrohi_core_developers.microsession_assemble_data_wrapper_hashtable
        ...
        prc_.state_changed_before_package_arrival = function (ht_wrapper) {
            try {
                ...
                window.raudrohi.tmg('6bfd055a-f78c-4c6f-b28e-13202011abd7', err);
            } // catch
        ...
        //  window.raudrohi.widgets.g1.router2hostserver instead.
        prc_.send2server_t1 =
        function (s_formscript_processor_name, ht_data, s_return_command) {
            try {
                if (raudrohi_settings_debug_JavaScript === true) {
                    window.raudrohi.base.assert_isString(s_formscript_processor_name,
                        's_formscript_processor_name',
                        'a542f055-74c8-4322-838e-13202011abd7');
                    window.raudrohi.base.assert_isObject(ht_data, 'ht_data',
                        '839b3b5b-c18e-400b-927e-13202011abd7');
                    window.raudrohi.base.assert_isString(s_return_command,
                        's_return_command',
                ...
                ht_wrapper.put('data', window.raudrohi.lang.ht2ProgFTE(ht_data));
                window.raudrohi.base.pool_of_hashtables.return_used_hashtable(ht_data);
                window.raudrohi.apparch1.send2server(s_formscript_processor_name,
                    instance_public_.phone.get_phone_number(),
                    window.raudrohi.lang.ht2ProgFTE(ht_wrapper));
                window.raudrohi.base.pool_of_hashtables.return_used_hashtable(ht_wrapper);
            } catch (err) {
                window.raudrohi.tmg('6257ac8b-060b-4351-b97e-13202011abd7', err);
            } // catch
        } //  send2server_t1
        ...
        function (s_destination_phonenumber, s_destination_command, ht_data,
            ...
            try {
                if (raudrohi_settings_debug_JavaScript === true) {
                    window.raudrohi.base.assert_isString(s_destination_phonenumber,
                        's_destination_phonenumber',
                        '25059728-edae-489a-957e-13202011abd7');
                    window.raudrohi.base.assert_isString(s_destination_command,
                ...
                window.raudrohi.tmg('879efd15-7588-49d6-a56e-13202011abd7', err);
            } // catch
        } //  prc_.threadjump_send
        ...
        function (ht_wrapper_tht_came_in_with_only_data_field_modified) {
            try {
                ...
                window.raudrohi.tmg('b03bbe4c-4b2d-47b5-816e-13202011abd7', err);
            } // catch
        } //  prc_.threadjump_send_reply
        ...
        function (s_destination_phonenumber, s_destination_command, ht_wrapper,
            ...
            try {
                ...
                window.raudrohi.tmg('87bf6a4b-4073-413b-845e-13202011abd7', err);
            } // catch
        } // prc_.threadjump_redirect_outwards
        ...
        prc_.threadjump_redirect_inwards = function (ht_wrapper) {
            try {
                ...
                window.raudrohi.tmg('c93c6871-ebc8-4853-825e-13202011abd7', err);
            } // catch
        } // prc_.threadjump_redirect_inwards


        // Returns window.raudrohi.core.pair, where
        // window.raudrohi.core.pair.a==true,  if operation failed and
        // window.raudrohi.core.pair.a==false, if operation succeeded.
        // The window.raudrohi.core.pair.b is assigned the data hashtable.
        ...
        function (ht_wrapper) {
            try {
                ...
                var a_pair = new window.raudrohi.core.pair();
                a_pair.a = true;
                a_pair.b = null;
                ...
                window.raudrohi.tmg('df3990f3-2bad-4f96-935e-13202011abd7', err);
            } // catch
        ...
        prc_.microsession_dismiss_all = function () {
            try {
                ...
                window.raudrohi.tmg('237335b4-42c5-4448-b55e-13202011abd7', err);
            } // catch
        ...
        // window.raudrohi.core.pair.a==true,  if operation failed and
        // window.raudrohi.core.pair.a==false, if operation succeeded.
        // The window.raudrohi.core.pair.b is assigned the wrapper hashtable.
        instance_public_.only_for_raudrohi_core_developers.microsession_receive_txt_t2 =
        function (wrapper_hashtable_progfte) {
            try {
                if (raudrohi_settings_debug_JavaScript === true) {
                    window.raudrohi.base.assert_isString(wrapper_hashtable_progfte,
                        'wrapper_hashtable_progfte',
                        '42a52d32-791b-4aba-b45e-13202011abd7');
                } // if
                var ht_wrapper = window.raudrohi.lang.ProgFTE2ht(wrapper_hashtable_progfte);
                var ht_wrapper_data = window.raudrohi.lang.ProgFTE2ht(
                    ht_wrapper.get('data'));
                ...
                window.raudrohi.tmg('ec401b28-22c2-48ac-924e-13202011abd7', err);
            } // catch
        } // instance_public_.only_for_raudrohi_core_developers.microsession_receive_txt_t2
        ...
        prc_.threadjump_receive = function (ht_wrapper) {
            try {
                ...
                window.raudrohi.base.assert_isNotnull(a_pr1, 'a_pr1',
                ...
                if (instance_public_.thrjr_[destination_command] ===
                    ...
                    if (instance_public_.thrjr_.default_command === undefined) {
                        if (raudrohi_settings_debug_JavaScript === true) {
                            window.raudrohi.tmg('148f7355-0857-4a91-814e-13202011abd7',
                                'instance_public_.thrjr_' +
                                destination_command +
                                " does not exist in \n" +
                                instance_public_.phone.get_phone_number() +
                ...
                window.raudrohi.tmg('507823fb-1af6-4899-a54e-13202011abd7', err);
            } // catch
        ...
        prc_.evh_button_logout_t1 = function (e) {
            try {
                ...
                window.raudrohi.widgets.g1.triggerTransition('resurrect', 'shutdown',
                ...
                window.raudrohi.tmg('45884265-7355-4416-844e-13202011abd7', err);
            } // catch
        ...
        prc_.repaint_if_graphical_and_not_hidden = function () {
            try {
                ...
                window.raudrohi.tmg('19d9731b-f4bd-4fdb-854e-13202011abd7', err);
            } // catch
        ...
        prc_.selfread.wrap_2_alignment_div = function (s_html_2_wrap) {
            try {
                if (raudrohi_settings_debug_JavaScript === true) {
                    window.raudrohi.base.assert_isString(s_html_2_wrap,
                        's_html_2_wrap',
                ...
                window.raudrohi.tmg('aec1d235-07ec-4271-b23e-13202011abd7', err);
            } // catch
        } // prc_.repaint_if_graphical_and_not_hidden
            ...
            try {
                ...
                switch (brancher) {
                    ...
                    case 'shutdown':
                        ...
                        break;
                    case 'change_state_2':
                        a_pr2 = window.raudrohi.base.bisect(a_pair.b, '|||');
                ...
                window.raudrohi.tmg('8a68c65e-4585-4f57-920e-13202011abd7', err);
            } // catch
        ...
        this.receive_phonecall_t1 = function (a_phonecall_instance) {
            try {
                ...
                window.raudrohi.tmg('59db1651-4947-424d-92fd-13202011abd7',
        ...
        window.raudrohi.tmg('4ff45b75-bda5-4318-a6fd-13202011abd7', err);
    } // catch
} // window.raudrohi.widgets.g1.pileofmethods_t1
