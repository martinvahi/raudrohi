...
if (window.raudrohi.globals.raudrohi_lang_exists !== true) {
    window.raudrohi.lang = {};
    window.raudrohi.globals.raudrohi_lang_exists = true;
} // if
if (window.raudrohi.globals.raudrohi_lang_private_code_exists !== true) {
    window.raudrohi.lang.private_code = {};
    window.raudrohi.globals.raudrohi_lang_private_code_exists = true;
} // if
if (window.raudrohi.globals.raudrohi_lang_debug_exists !== true) {
    window.raudrohi.lang.debug = {};
    window.raudrohi.globals.raudrohi_lang_debug_exists = true;
} // if
if (window.raudrohi.globals.raudrohi_lang_comm_exists !== true) {
    window.raudrohi.lang.comm = {};
    window.raudrohi.globals.raudrohi_lang_comm_exists = true;
} // if
if (window.raudrohi.globals.raudrohi_lang_comm_phonestation_t1_exists !== true) {
    window.raudrohi_lang_comm_phonestation_t1 = {};
    window.raudrohi.globals.raudrohi_lang_comm_phonestation_t1_exists = true;
} // if
if (window.raudrohi.globals.raudrohi_lang_comparison_exists !== true) {
    window.raudrohi.lang.comparison = {};
    window.raudrohi.globals.raudrohi_lang_comparison_exists = true;
} // if
if (window.raudrohi.globals.raudrohi_lang_comparison_goe_exists !== true) {
    window.raudrohi.lang.comparison.goe = {};
    window.raudrohi.globals.raudrohi_lang_comparison_goe_exists = true;
} // if

if (window.raudrohi.globals.raudrohi_lang_selftests_exists !== true) {
    // TODO: move all selftests from this file to the selftests file.
    window.raudrohi.lang.selftests = {};
    window.raudrohi.globals.raudrohi_lang_selftests_exists = true;
} // if


//-------------------------------------------------------------------------
window.raudrohi.globals.raudrohi_core_burnCPUcycles_helpervar_ = 0;
window.raudrohi.globals.raudrohi_core_burnCPUcycles_helpervar2_ = 0;
...
window.raudrohi.core.burnCPUcycles = function (number_of_batches) {
    try {
        if (number_of_batches < 0) {
            window.raudrohi.tmg('806c712c-2a7e-44cc-822a-310261704dd7',
                'number_of_batches(==' + number_of_batches + ') < 0');
        } // if
        var i = 0;
        while ((i++) <= number_of_batches) {
            window.raudrohi.globals.raudrohi_core_burnCPUcycles_helpervar_ = number_of_batches +
                window.raudrohi.globals.raudrohi_core_burnCPUcycles_helpervar_;
            if ((i % 3) === 0) {
            ...
            switch (s_vardec_in_a_loop) {
                case '1':
                    window.raudrohi.globals.raudrohi_core_burnCPUcycles_helpervar_ = 2 + i +
                        window.raudrohi.globals.raudrohi_core_burnCPUcycles_helpervar_;
                    break;
                case '7':
                    window.raudrohi.globals.raudrohi_core_burnCPUcycles_helpervar_ = 5 - i +
                        window.raudrohi.globals.raudrohi_core_burnCPUcycles_helpervar_;
                    break;
                case '17':
                    window.raudrohi.globals.raudrohi_core_burnCPUcycles_helpervar2_ = 11 +
                        window.raudrohi.globals.raudrohi_core_burnCPUcycles_helpervar_ +
                        number_of_batches;
                    break;
                default:
        ...
        window.raudrohi.tmg('5e3c6e8d-c091-45a0-911a-310261704dd7', err);
    } // catch
...
window.raudrohi.lang.htQueue = function () {
    // The -100 is a dirty, incorrect, thing for safety due to the
    // non-threadsafetyness of the queue.
    var N_max_ = window.raudrohi.core.safe_positive_int - 100;
    ...
    function rehash_if_needed() {
        ...
        try {
            ...
            window.raudrohi.tmg('b42ad731-d878-4f91-b41a-310261704dd7', err);
        } // catch
    } // rehash_if_needed()
    ...
    this.push = function (element) {
        try {
            rehash_if_needed();
            var elem_id = window.raudrohi.base.generate_id();
            ht_keys_.put(elem_id, N_high_);
            ht_keys_reverse_.put(N_high_, elem_id);
            ht_.put(N_high_++, element);
            return elem_id;
        } catch (err) {
            window.raudrohi.tmg('cb752140-48b4-471f-931a-310261704dd7', err);
        } // catch
    }; // this.push
    ...
    this.pop = function () {
        try {
            ...
            window.raudrohi.tmg('dd593d5e-a054-4ff2-940a-310261704dd7', err);
        } // catch
    }; // this.pop
    ...
    this.replace_value = function (element_id, element_new_value) {
        ...
        try {
            ...
            if (raudrohi_settings_debug_JavaScript === true) {
                window.raudrohi.tmg('52186bad-aa85-4296-a40a-310261704dd7', err);
            }
            return false;
        } // catch
    ...
    this.get = function (element_id) {
        try {
            ...
            window.raudrohi.tmg('fc397b50-64d7-47f1-b10a-310261704dd7', err);
        } // catch
    } // get
    ...
    this.get_a_clone_of_the_first_element_to_exit = function () {
        try {
            ...
            window.raudrohi.tmg('2b05b11d-f6ac-47fd-850a-310261704dd7', err);
        } // catch
...
window.raudrohi.lang.map_hashtable =
    function (ht, a_function_name, a_function_argument) {
        try {
            ...
            window.raudrohi.tmg('ecf1b914-2c27-41dd-830a-310261704dd7', err);
        } // catch
    }; // window.raudrohi.lang.map_hashtable

// It's the same as the window.raudrohi.lang.map_hashtable, except that
// for argumentless functions.
window.raudrohi.lang.map_hashtable_t2 = function (ht, a_function_name) {
    try {
        // TODO: refactor it out by merging it with the
        // window.raudrohi.lang.map_hashtable and turning that
        ...
        window.raudrohi.tmg('6a99bd21-0fbf-44b5-a40a-310261704dd7', err);
    } // catch
}; // window.raudrohi.lang.map_hashtable_t2

//------------------------------------------------------------------------

// multiply_string('Hi',3)==='HiHiHi'. It's inspired by the Ruby
// feature, where 'Hi'*3==='HiHiHi'.
window.raudrohi.lang.multiply_string = function (a_string, an_integer) {
    try {
        if (raudrohi_settings_debug_JavaScript === true) {
            window.raudrohi.base.assert_isString(a_string, 'a_string',
                'ada86e50-aa1c-4e45-a30a-310261704dd7');
            window.raudrohi.base.assert_isNumber(an_integer, 'an_integer',
                '4984b215-d85b-42bc-b80a-310261704dd7');
        } // if
        if (an_integer < 0) {
            window.raudrohi.tmg('574e9088-09ba-4d31-94f9-310261704dd7',
    ...
    function (fixed_string_length, substring, substring_horizontal_alignment) {
        try {
            ...
            switch (substring_horizontal_alignment) {
                case 'left':
                    s_right = window.raudrohi.lang.multiply_string(s_an_em, n_of_spaces);
                    break;
                case 'right':
                    s_left = window.raudrohi.lang.multiply_string(s_an_em, n_of_spaces);
                    break;
                case 'center':
                    if ((n_of_spaces % 2) === 0) {
                        x = n_of_spaces / 2;
                        xx = window.raudrohi.lang.multiply_string(s_an_em, x);
                        s_left = xx;
                        s_right = xx;
                    } else {
                        x = (n_of_spaces - 1) / 2;
            ...
            window.raudrohi.tmg('3b1cc423-f11b-4fed-bbf9-310261704dd7', err);
        } // catch
    } // fixed_width_string_html

//------------------------------------------------------------------------
// The impl exist only for easying the testing.
window.raudrohi.lang.generate_nonexisting_needle_impl =
    function (haystack_string, an_integer) {
        try {
            window.raudrohi.base.assert_isString(haystack_string, 'haystack_string',
                'a7000a57-d921-47e4-81e9-310261704dd7');
            var s0 = window.raudrohi.base.normalize_whitespaces(haystack_string);
            var s1 = window.raudrohi.base.normalize_linebreaks(s0);
            s0 = window.raudrohi.base.gsub('', ' ', s1);
            ...
            window.raudrohi.tmg('07c4724f-bdec-4dca-93e9-310261704dd7', err);
        } // catch
...
window.raudrohi.lang.generate_nonexisting_needle = function (haystack_string) {
    try {
        var s_needle = window.raudrohi.lang.generate_nonexisting_needle_impl(
            haystack_string, window.raudrohi.base.i_rand_t1(100, 999));
        return s_needle;
    } catch (err) {
        window.raudrohi.tmg('c4265f54-07ca-49c4-b3e9-310261704dd7', err);
    } // catch
} // generate_nonexisting_needle

window.raudrohi.lang.selftests.generate_nonexisting_needle = function () {
    try {
        ...
        var s_needle = window.raudrohi.lang.generate_nonexisting_needle_impl(s, 7);
        if (s_needle !== 'X7') {
            ar_failed_tests.push('X7, s_needle==' + s_needle);
        } // if
        s_needle = window.raudrohi.lang.generate_nonexisting_needle_impl(s, 5);
        if (s_needle !== 'X5Y') {
            ar_failed_tests.push('X5Y, s_needle==' + s_needle);
        } // if
        var b = false;
        try {
            s_needle = window.raudrohi.lang.generate_nonexisting_needle(s);
        }
        catch (err0) {
            b = true;
        }// catch err0
        ...
        if (0 < x_FireFox_bug_workaround) {
            ...
            ht.put('code_region_name',
                'window.raudrohi.lang.selftests.generate_nonexisting_needle');
            ht.put('ar_failed_tests', ar_failed_tests);
        } // if
        return ht;
    }
    catch (err) {
        window.raudrohi.tmg('62254fbb-f49a-4d88-a7e9-310261704dd7', err);
    } // catch
} // window.raudrohi.lang.selftests.generate_nonexisting_needle
...
window.raudrohi.lang.str2lines = function (a_string) {
    try {
        window.raudrohi.base.assert_isString(a_string, 'a_string',
        ...
        var s0 = window.raudrohi.base.normalize_linebreaks(a_string);
        // The trickery is due to a fact that the JavaScript
        // standard split does not work with  the "\n".
        var s_needle_linebreak = window.raudrohi.lang.generate_nonexisting_needle(s0);
        var s_needle_bounds = window.raudrohi.lang.generate_nonexisting_needle(s0 +
            s_needle_linebreak);
        ...
        for (i = 0; i < len; i++) {
            s_line = ar[i];
            ar1.push(window.raudrohi.base.gsub('', s_needle_bounds, s_line));
        } // for
        return ar1;
    } catch (err) {
        window.raudrohi.tmg('0a11022b-4e2a-481b-94e9-310261704dd7', err);
    } // catch
} // str2lines

window.raudrohi.lang.selftests.str2lines = function () {
    try {
        var ht = new Hashtable();
        ht.put('test_passed', 't');
        var ar_failed_tests = [];
        //---tests-start------------------
        var s = "line1\nline2";
        var ar = window.raudrohi.lang.str2lines(s);
        ...
        s = "\nline77\nline99\n";
        ar = window.raudrohi.lang.str2lines(s);
        ...
        if (0 < x_FireFox_bug_workaround) {
            ht.put('test_passed', 'f');
            ht.put('code_region_name', 'window.raudrohi.lang.selftests.str2lines');
            ht.put('ar_failed_tests', ar_failed_tests);
        } // if
        return ht;
    } catch (err) {
        window.raudrohi.tmg('22444345-a0fe-4869-b2e9-310261704dd7', err);
    } // catch
} // window.raudrohi.lang.selftests.str2lines


// Converts a multiline string to a HTML string of a table. It retains
// all spaces, including multiple spaces.
window.raudrohi.lang.fixed_size_string_html = function (a_multiline_string) {
    try {
        window.raudrohi.base.assert_isString(a_multiline_string, 'a_multiline_string',
            '35bdc31f-7ba1-4b84-a3d9-310261704dd7');
        var s_html = '<table class="raudrohi_positioning_table"><tbody>';
        var s1 = window.raudrohi.base.gsub('&nbsp;', ' ',
            window.raudrohi.base.normalize_whitespaces(a_multiline_string));
        var ar = window.raudrohi.lang.str2lines(s1);
        var len = ar.length;
        var i = 0;
        var elem;
        for (i = 0; i < len; i++) {
        ...
        window.raudrohi.tmg('3b39f634-7067-4d31-b2d9-310261704dd7', err);
    } // catch
...
raudrohi_lang_comm_phonecall =
    function (origin_phone_number, destination_phone_number, data, data2) {
        window.raudrohi.base.assert_isString(data, 'data',
...
// key   == window.raudrohi.lang.comm.phone.phone_number
// value == window.raudrohi.lang.comm.phone
// It's a list of all phones that are "within the phone network".
window.raudrohi_lang_comm_phonestation_t1.phones = new Hashtable();
...
window.raudrohi.lang.comm.phone = function (a_phone_number_as_a_string) {
    ...
    this.connect2phonestation = function () {
        try {
            ...
            if (window.raudrohi_lang_comm_phonestation_t1.phones.containsKey(phone_number_)) {
                window.raudrohi.tmg('499f7d91-50ae-43cc-9ed9-310261704dd7',
                    'A phone with a phone number of ' + phone_number_ +
                        ' has already been registered to the phonestation.');
            }//if
            window.raudrohi_lang_comm_phonestation_t1.phones.put(phone_number_,
                self_public_);
            is_connected_ = true;
        }
        catch (err) {
            window.raudrohi.tmg('5e3cd1a3-6a8e-494c-a3d9-310261704dd7', err);
        } // catch
    ...
    this.disconnect_from_phonestation = function () {
        try {
            ...
            window.raudrohi_lang_comm_phonestation_t1.phones.remove(phone_number_);
            is_connected_ = false;
        }
        catch (err) {
            window.raudrohi.tmg('401b2730-e4db-425a-81d9-310261704dd7', err);
        } // catch
    ...
    this.receive_phonecall = function (a_phonecall_instance) {
        throw "\n------------------------\n" +
            'window.raudrohi.lang.comm.phone.receive_phonecall has to be overriden.' +
            "\nGUID=='04aeca5a-badf-4645-b2d9-310261704dd7'";
    }; // this.receive

    this.call = function (destination_phone_number, data, data2) {
        try {
            if (window.raudrohi_lang_comm_phonestation_t1.phones.containsKey(destination_phone_number) !==
                true) {
                if (raudrohi_settings_debug_JavaScript === true) {
                    window.raudrohi.tmg('40a9d05f-3b30-4321-91c9-310261704dd7',
                        'Phone # ' + destination_phone_number +
                            ' was not in phonenetwork.');
                } // if
                return;
            } // if
            var phone = window.raudrohi_lang_comm_phonestation_t1.phones.get(
            ...
            window.raudrohi.tmg('3d79a8ca-a459-4fbd-84c9-310261704dd7',
    ...
    this.destruct_phone = function () {
        try {
            ...
            window.raudrohi.tmg('a5e84e4c-9ade-4d6e-84c9-310261704dd7', err);
        } // catch
    }; // this.destruct

}; //window.raudrohi.lang.phone

//-------------------------------------------------------------------------
// I's a black hole for useless phonecalls, just like the /dev/null
// is in Linux.
window.raudrohi.lang.phonebooth_dev_null = function () {
    this.phone = new window.raudrohi.lang.comm.phone('/dev/null');
    this.phone.receive_phonecall = function (a_phonecall_instance) {
    }
} // window.raudrohi.lang.phonebooth_dev_null

//-------------------------------------------------------------------------
window.raudrohi.lang.userinterface_text = function () {
    try {
            ...
            try {
                ...
                if (raudrohi_settings_debug_JavaScript === true) {
                    if (raudrohi_adapter_isNumber(i_text_number) !== true) {
                        window.raudrohi.adapter.log(i_text_number +
                            " is not a number");
                    } // if
                    element_id = '' +
                    ...
                    if (window.raudrohi.base.node_exists(element_id) !== true) {
                        window.raudrohi.tmg('149de612-3f70-4a80-95c9-310261704dd7',
                ...
                if (x === null) {
                    window.raudrohi.adapter.log("UI text not found.\n" +
                        'element_id==' + element_id);
                } // if
                return x.innerHTML;
            } catch (err) {
                window.raudrohi.tmg('75992458-0471-41a3-a2c9-310261704dd7', err);
            } // catch
        } // get_from_DOM
        ...
        this.get = function (i_text_number) {
            try {
                ...
                window.raudrohi.tmg('2f18feb6-dc29-4c0a-83c9-310261704dd7', err);
            } // catch
        } // get

    }
    catch (err) {
        window.raudrohi.tmg('5c745965-7a95-47ce-abb9-310261704dd7', err);
    } // catch
} // window.raudrohi.lang.userinterface_text


//-------------------------------------------------------------------------
// If show_them==false, the elements are hidden. Otherwise the elements
//  are made visible.
window.raudrohi.lang.set_visibility_ar =
    function (an_array_of_element_names, show_them) {
        try {
            var len = an_array_of_element_names.length;
            var an_elem_name;
            var cache_func_ras = window.raudrohi.adapter.setAttribute; // IE optimization
            for (var i = 0; i < len; i++) {
            ...
            window.raudrohi.tmg('7bc2064d-4a15-4336-a5b9-310261704dd7', err);
        } // catch
    } // window.raudrohi.lang.set_visibility_ar

window.raudrohi.lang.set_visibility =
    function (element_id, true_if_element_is_visible) {
        var ss_id = '';
        try {
            if (!raudrohi_adapter_isString(element_id)) {
                window.raudrohi.tmg('04118021-cac4-442e-9969-310261704dd7',
                    'The element_id is not a string and has a value of ' +
                        element_id);
            } // if
            ss_id = element_id;
            if (!raudrohi_adapter_isBoolean(true_if_element_is_visible)) {
                window.raudrohi.tmg('8cf27e16-42eb-47fd-b569-310261704dd7',
            ...
            if (true_if_element_is_visible) {
                window.raudrohi.adapter.setAttribute(element_id,
            ...
            window.raudrohi.tmg('de4b222b-3922-4445-9469-310261704dd7',
...
// An example:
//
// var gate=new window.raudrohi.lang.mutex_gate();
...
window.raudrohi.lang.mutex_gate = function () {
    ...
    this.lock_it_successfully = function () {
        try {
            ...
            window.raudrohi.tmg('051e8411-79f4-4c0f-a559-310261704dd7', err);
        } // catch
...
} // window.raudrohi.lang.threadsafe_flag
...
//
// a_machine=function(){
// var startup_shutdown_handler_=new window.raudrohi.lang.startup_shutdown_handler(this);
//
...
window.raudrohi.lang.startup_shutdown_handler = function (machine_instance) {
    try {
        var self_public_ = this;
        ...
        function update_machine_state() {
            try {
                ...
                window.raudrohi.tmg('17421885-edce-4abc-af59-310261704dd7', err);
            } // catch
        ...
        this.startbutton_pushed = function () {
            try {
                ...
                window.raudrohi.tmg('4bd91952-6f7d-473d-b359-310261704dd7', err);
            } // catch
        } // startbutton_pushed
        ...
        this.stopbutton_pushed = function () {
            try {
                ...
                window.raudrohi.tmg('a29d4a47-b35e-45cc-a159-310261704dd7', err);
            } // catch
        } // stopbutton_pushed
        ...
        this.stopbutton_pushed_with_indication_request =
            function (phone_number_of_an_instance_to_call_when_shutdown_complete, data_string_to_send_for_indication, binary_data_to_send_for_indication) {
                try {
                    if (raudrohi_settings_debug_JavaScript === true) {
                    ...
                    window.raudrohi.tmg('a0204432-4093-4f42-8749-310261704dd7', err);
                } // catch
            } // stopbutton_pushed_with_indication_request

        this.startbutton_pushed_with_indication_request =
            function (phone_number_of_an_instance_to_call_when_startup_complete, data_string_to_send_for_indication, binary_data_to_send_for_indication) {
                try {
                    if (raudrohi_settings_debug_JavaScript === true) {
                        window.raudrohi.base.assert_isString(
                    ...
                    window.raudrohi.tmg('1d41a672-41e4-481d-8d49-310261704dd7', err);
                } // catch
        ...
        this.hook_startup_started = function () {
            try {
                ...
                window.raudrohi.tmg('aa56dc25-37e4-4496-b449-310261704dd7', err);
            } // catch
        ...
        this.hook_startup_complete = function () {
            try {
                ...
                window.raudrohi.tmg('0757245c-95b4-434d-9249-310261704dd7', err);
            } // catch
        ...
        this.hook_shutdown_started = function () {
            try {
                ...
                window.raudrohi.tmg('c614c216-d397-47f3-b539-310261704dd7', err);
            } // catch
        ...
        this.hook_shutdown_complete = function () {
            try {
                ...
                window.raudrohi.tmg('bb639946-4676-4693-8239-310261704dd7', err);
            } // catch
        } // hook_shutdown_complete

    } catch (err) {
        window.raudrohi.tmg('833dc44a-7a17-4613-8139-310261704dd7', err);
    } // catch
} // window.raudrohi.lang.startup_shutdown_handler

//-------------------------------------------------------------------------
window.raudrohi.lang.startup_shutdown_machines =
    function (array_of_machines, true_if_startup, a_phone_instance) {
        if (raudrohi_settings_debug_JavaScript === true) {
            if (!raudrohi_adapter_isArray(array_of_machines)) {
                window.raudrohi.tmg('2f1442e5-be3a-42d5-9639-310261704dd7',
        ...
        try {
            ...
            window.raudrohi.tmg('397c8136-9528-4f77-8129-310261704dd7', err);
        } // catch
    } // startup_shutdown_machines

//-------------------------------------------------------------------------
window.raudrohi.lang.deserialize_htOfht_from_ProgFTE = function (a_string) {
    try {
        var htOfht = window.raudrohi.lang.ProgFTE2ht(a_string);
        var ht_out = window.raudrohi.base.pool_of_hashtables.get_empty_hashtable();
        var keys = htOfht.keys();
        var len = keys.length;
        var key;
        var ref_2_s_progfte;
        var cache_func_rlP = window.raudrohi.lang.ProgFTE2ht; // IE optimization
        for (var i = 0; i < len; i++) {
            key = keys[i];
            ref_2_s_progfte = htOfht.get(key);
            ht_out.put(key, cache_func_rlP(ref_2_s_progfte));
        } // for
        window.raudrohi.base.pool_of_hashtables.return_used_hashtable(htOfht);
        return ht_out;
    } catch (err) {
        window.raudrohi.tmg('60366553-193d-499d-8429-310261704dd7', err +
            ' a_string==' +
            a_string);
    } // catch
} // window.raudrohi.lang.deserialize_htOfht_from_ProgFTE

//-------------------------------------------------------------------------
window.raudrohi.lang.extract_column_from_htOfht =
    function (hashtable_of_hashtables, column_name) {
        try {
            if (raudrohi_settings_debug_JavaScript === true) {
                window.raudrohi.base.assert_isObject(hashtable_of_hashtables,
                    'hashtable_of_hashtables',
                    'ae232a5d-e504-47ce-8229-310261704dd7');
                window.raudrohi.base.assert_isString(column_name, 'column_name',
            ...
            if (raudrohi_settings_debug_JavaScript === true) {
                for (i = 0; i < len; i++) {
                    ...
                    window.raudrohi.base.assert_isObject(ref2ht, 'ref2ht',
                        'fd314c3e-bad3-4068-8529-310261704dd7');
                    if (!ref2ht.containsKey(column_name)) {
                        window.raudrohi.tmg('a99b083d-eafd-4580-8119-310261704dd7',
            ...
            window.raudrohi.tmg('3967cd65-4c25-41f5-b419-310261704dd7', err);
        } // catch
    } // window.raudrohi.lang.deserialize_htOfht_from_ProgFTE
...
window.raudrohi.lang.hashtable_signature = function (a_hashtable) {
    try {
        if (raudrohi_settings_debug_JavaScript === true) {
            ...
            for (i = 0; i < len; i++) {
                ...
                if (!raudrohi_adapter_isString(reference_to_the_value)) {
                    if (!raudrohi_adapter_isBoolean(reference_to_the_value)) {
                        window.raudrohi.base.assert_isNumber(reference_to_the_value,
        ...
        window.raudrohi.tmg('fb83ca4f-63fa-45f8-b419-310261704dd7', err);
    } // catch
} // window.raudrohi.lang.hashtable_signature


window.raudrohi.lang.is_a_hexadecimal_digit =
    function (hex_digit_candidate_as_a_string) {
        try {
            if (raudrohi_settings_debug_JavaScript === true) {
                window.raudrohi.base.assert_isString(hex_digit_candidate_as_a_string,
            ...
            window.raudrohi.tmg('1d10db30-1807-45a7-9209-310261704dd7', err);
        } // catch
    } // window.raudrohi.lang.is_a_hexadecimal_digit

window.raudrohi.lang.is_a_hexadecimal_number =
    function (hex_digit_candidate_as_a_string) {
        try {
            if (raudrohi_settings_debug_JavaScript === true) {
                window.raudrohi.base.assert_isString(hex_digit_candidate_as_a_string,
            ...
            for (i = 0; i < len; i++) {
                ...
                if (window.raudrohi.lang.is_a_hexadecimal_digit(chr) !== true) {
                    answer = false;
                    break;
                } // if
            } // for
            ...
            window.raudrohi.tmg('495e0225-2b3e-442a-9409-310261704dd7', err);
        } // catch
    } // window.raudrohi.lang.is_a_hexadecimal_number

window.raudrohi.lang.selftests.is_a_hexadecimal_number = function () {
    try {
        var ht = new Hashtable();
        ht.put('test_passed', 't');
        var ar_failed_tests = [];
        //---tests-start------------------
        if (window.raudrohi.lang.is_a_hexadecimal_number('ff') !== true) {
            ar_failed_tests.push('ff');
        } // if
        if (window.raudrohi.lang.is_a_hexadecimal_number('ff00ff') !== true) {
            ar_failed_tests.push('ff00ff');
        } // if
        if (window.raudrohi.lang.is_a_hexadecimal_number('0000') !== true) {
            ar_failed_tests.push('0000');
        } // if
        if (window.raudrohi.lang.is_a_hexadecimal_number('1234567890') !== true) {
            ar_failed_tests.push('1234567890');
        } // if
        if (window.raudrohi.lang.is_a_hexadecimal_number('ABCDEF') !== true) {
            ar_failed_tests.push('ABCDEF');
        } // if
        if (window.raudrohi.lang.is_a_hexadecimal_number('ABcDeF') !== true) {
            ar_failed_tests.push('ABcDeF');
        } // if
        if (window.raudrohi.lang.is_a_hexadecimal_number('XX') !== false) {
            ar_failed_tests.push('XX, value==' +
                window.raudrohi.lang.is_a_hexadecimal_number('XX'));
        } // if
        //---tests-end--------------------
        var x_FireFox_bug_workaround = ar_failed_tests.length;
        if (0 < x_FireFox_bug_workaround) {
            ht.put('test_passed', 'f');
            ht.put('code_region_name',
                'window.raudrohi.lang.selftests.is_a_hexadecimal_number');
            ht.put('ar_failed_tests', ar_failed_tests);
        } // if
        return ht;
    } catch (err) {
        window.raudrohi.tmg('5a1efaf4-60e5-4ee1-a809-310261704dd7', err);
    } // catch
} // window.raudrohi.lang.selftests.is_a_hexadecimal_number

//-------------------------------------------------------------------------
window.raudrohi.lang.private_code.is_a_whole_number_x_or_s =
    function (i_or_s_whole_number_candidate, b_allow_string_representation) {
        try {
            ...
            window.raudrohi.tmg('8fe5475d-c47e-44bb-9409-310261704dd7', err);
        } // catch
    } // window.raudrohi.lang.private_code.is_a_whole_number_x_or_s

window.raudrohi.lang.is_a_whole_number_x_or_s =
    function (whole_number_candidate_as_int_or_string) {
        try {
            var b_allow_string_representation = true;
            var b_out = window.raudrohi.lang.private_code.is_a_whole_number_x_or_s(
                whole_number_candidate_as_int_or_string,
                b_allow_string_representation);
            return b_out;
        } catch (err) {
            window.raudrohi.tmg('13cdf452-4d03-47d0-abf8-310261704dd7', err);
        } // catch
    } // window.raudrohi.lang.is_a_whole_number_x_or_s


window.raudrohi.lang.is_a_whole_number =
    function (whole_number_candidate_as_int_or_string) {
        try {
            ...
            window.raudrohi.tmg('be5b9022-cbe7-4248-b1f8-310261704dd7', err);
        } // catch
    } // window.raudrohi.lang.is_a_whole_number

window.raudrohi.lang.assert_is_a_whole_number =
    function (a_variable, a_variable_name, Globally_Unique_Identifier_as_string, s_optional_errmsg_suffix) {
        s_optional_errmsg_suffix = typeof(s_optional_errmsg_suffix) !==
            'undefined' ? s_optional_errmsg_suffix : '';
        if (!window.raudrohi.lang.is_a_whole_number(a_variable)) {
...
window.raudrohi.lang.is_an_HTML_color = function (color_candidate_as_a_string) {
    try {
        if (raudrohi_settings_debug_JavaScript === true) {
            window.raudrohi.base.assert_isString(color_candidate_as_a_string,
        ...
        window.raudrohi.tmg('5426fc4c-5f35-4e6b-a3f8-310261704dd7', err);
    } // catch
} // window.raudrohi.lang.is_an_HTML_color

window.raudrohi.lang.assert_is_an_HTML_color =
    function (a_variable, a_variable_name, Globally_Unique_Identifier_as_string, s_optional_errmsg_suffix) {
        s_optional_errmsg_suffix = typeof(s_optional_errmsg_suffix) !==
            'undefined' ? s_optional_errmsg_suffix : '';
        ...
        if (!window.raudrohi.lang.is_an_HTML_color(a_variable)) {
            window.raudrohi.tmg(Globally_Unique_Identifier_as_string,
...
//-------------------------------------------------------------------------
window.raudrohi.lang.number2str =
    function (a_number, a_string_that_marks_the_floating_point) {
        try {
            if (raudrohi_settings_debug_JavaScript === true) {
                window.raudrohi.base.assert_isNumber(a_number, 'a_number',
                ...
                if (a_string_that_marks_the_floating_point === '') {
                    window.raudrohi.tmg('7f4e8320-ae62-46f0-81e8-310261704dd7',
                        'The floating point separator is not allowed ' +
                            'to be an empty string.');
                } // if
            } // if
            var s = window.raudrohi.base.gsub(a_string_that_marks_the_floating_point,
                '.', '' + a_number);
            return s;
        } catch (err) {
            window.raudrohi.tmg('93a3d2c8-e780-4f5f-b4e8-310261704dd7', err);
        } // catch
    } // number2str


window.raudrohi.lang.selftests.number2str = function () {
    try {
        var ht = new Hashtable();
        ht.put('test_passed', 't');
        var ar_failed_tests = [];
        //---tests-start------------------
        var s = window.raudrohi.lang.number2str(44.72, 'Z');
        if (s !== '44Z72') {
            ar_failed_tests.push('44Z72, s==' + s);
        } // if
        s = window.raudrohi.lang.number2str(99, ',');
        if (s !== '99') {
            ar_failed_tests.push('99, s==' + s);
        } // if
        s = window.raudrohi.lang.number2str(33.7, ',');
        if (s !== '33,7') {
            ar_failed_tests.push('33,7 , s==' + s);
        } // if
        s = window.raudrohi.lang.number2str(55.61, '.');
        if (s !== '55.61') {
        ...
        if (0 < x_FireFox_bug_workaround) {
            ht.put('test_passed', 'f');
            ht.put('code_region_name',
                'window.raudrohi.lang.selftests.number2str');
            ht.put('ar_failed_tests', ar_failed_tests);
        } // if
        return ht;
    } catch (err) {
        window.raudrohi.tmg('49645418-035f-4ab0-92e8-310261704dd7', err);
    } // catch
} // window.raudrohi.lang.selftests.number2str
//-------------------------------------------------------------------------
...
window.raudrohi.lang.fill_form = function (ar_needle_replacement_values, s_form) {
    try {
...
// kibuvits_writeln Raudrohi_cg_debug_verification.new(
...
// RENESSAATOR_AUTOGENERATED_TEXT_START
    if(raudrohi_settings_debug_JavaScript===true){
        ...
        // This code has been autogenerated by: Raudrohi_cg_debug_verification 
            window.raudrohi.base.assert_isArray(ar_needle_replacement_values,'ar_needle_replacement_values',
                '39776803-12a7-4d00-913e-83a360409dd7');
window.raudrohi.base.assert_isString(s_form,'s_form',
                '76b8a194-9b41-4f53-be3e-83a360409dd7');
...
// RENESSAATOR_BLOCK_END
        ...
        for (i = 0; i < len; i++) {
            ...
            s = window.raudrohi.base.gsub(s_substitution, s_needle, s_out);
            s_out = s
        } // for
        return s_out;
    } catch (err) {
        window.raudrohi.tmg('3e7137c1-ab8e-45a4-84d8-310261704dd7', err);
    } // catch
} // window.raudrohi.lang.fill_form


window.raudrohi.lang.selftests.fill_form = function () {
    try {
        var ht = new Hashtable();
        ht.put('test_passed', 't');
        var ar_failed_tests = [];
        ...
        var s_expected = "XAAY" +
            "BB\nZ[CODEGENERATION_BLANK_2]WW";
        var s_filled = window.raudrohi.lang.fill_form(ar, s_form);
        ...
        if (0 < x_FireFox_bug_workaround) {
            ht.put('test_passed', 'f');
            ht.put('code_region_name',
                'window.raudrohi.lang.selftests.fill_form');
            ht.put('ar_failed_tests', ar_failed_tests);
        } // if
        return ht;
    } catch (err) {
        window.raudrohi.tmg('62490117-0056-4992-93d8-310261704dd7', err);
    } // catch
} // window.raudrohi.lang.selftests.fill_form

//-------------------------------------------------------------------------
window.raudrohi.lang.queueCache = function (i_max_size) {
    try {
        if (raudrohi_settings_debug_JavaScript === true) {
            window.raudrohi.base.assert_isNumber(i_max_size, 'i_max_size',
                '553e2052-9757-478c-95d8-310261704dd7');
        } // if
        var ht_cache_ = new Hashtable();
        var queue_ = new window.raudrohi.lang.htQueue();
        ...
        this.put = function (s_key, x) {
            try {
                ...
                if (i_max_size_ < i_size) {
                    ...
                    //window.raudrohi.adapter.log("i_dismissal_size_=="+i_dismissal_size_);
                    //window.raudrohi.adapter.log("i_size=="+i_size);
                    try {
                        var s;
                        var i = 0;
                        for (i = 0; i < i_dismissal_size_; i++) {
                            s = queue_.pop();
                            ht_cache_.remove(s);
                            //window.raudrohi.adapter.log("s=="+s);
                        } // for
                    } catch (err) {
                        window.raudrohi.tmg('d668b15a-8327-4fe9-94d8-310261704dd7',
                            err);
                    } // catch
                } // if
            } catch (err) {
                window.raudrohi.tmg('a9450d4c-3e4d-4779-b3d8-310261704dd7', err);
            } // catch
        } // put
        ...
        this.clear = function () {
            try {
                ...
                window.raudrohi.tmg('5ad12719-1bdd-405a-a5c8-310261704dd7', err);
            } // catch
        } // containsKey


    } catch (err) {
        window.raudrohi.tmg('cbf31f53-1041-404c-a3c8-310261704dd7', err);
    } // catch
} // window.raudrohi.lang.queueCache

window.raudrohi.lang.selftests.queueCache = function () {
    try {
        var ht = new Hashtable();
        ht.put('test_passed', 't');
        var ar_failed_tests = [];
        //---tests-start------------------
        var ob_cache = new window.raudrohi.lang.queueCache(10);
        var len = 20;
        var i = 0;
        var s_key = null;
        for (i = 0; i < len; i++) {
        ...
        if (0 < x_FireFox_bug_workaround) {
            ht.put('test_passed', 'f');
            ht.put('code_region_name',
                'window.raudrohi.lang.selftests.queueCache');
            ht.put('ar_failed_tests', ar_failed_tests);
        } // if
        return ht;
    } catch (err) {
        window.raudrohi.tmg('1dbf9945-9a64-44d2-9578-310261704dd7', err);
    } // catch
} // window.raudrohi.lang.selftests.queueCache
...
window.raudrohi.lang.private_code.str2regexstr_do_it = function (s_needle) {
    try {
        // From window.raudrohi.base....:
        //      ar_in.push("|");
        ...
        window.raudrohi.tmg('62a0b158-fc69-47ee-8468-310261704dd7', err);
    } // catch
} // window.raudrohi.base.private_code.str2regexstr_do_it

// TODO: refactor it to use the queueCache.
window.raudrohi.lang.private_code.str2regexstr_ht_cache = new Hashtable();
// The queue is for throwing the oldest cached items out of the
// cache first. By putting a limit on the cache size, one avoids
// a memory leak.
window.raudrohi.lang.private_code.str2regexstr_ht_cache_queue =
    new window.raudrohi.lang.htQueue();

window.raudrohi.lang.str2regexstr = function (s_needle) {
    try {
        if (raudrohi_settings_debug_JavaScript === true) {
            window.raudrohi.base.assert_isString(s_needle, 's_needle',
                '84d58c36-56e9-410f-a168-310261704dd7');
        } // if
        var ht_cache = window.raudrohi.lang.private_code.str2regexstr_ht_cache;
        var s_out = null;
        if (ht_cache.containsKey(s_needle) === true) {
            s_out = ht_cache.get(s_needle);
            return "" + s_out;
        } // if
        s_out = window.raudrohi.lang.private_code.str2regexstr_do_it(s_needle);
        var queue = window.raudrohi.lang.private_code.str2regexstr_ht_cache_queue;
        var s = null;
        if (400 <= queue.length()) {
            var len = 20;
            var i = 0;
        ...
        window.raudrohi.tmg('fc82be3e-8f26-4723-8368-310261704dd7', err);
    } // catch
} // window.raudrohi.lang.str2regexstr

window.raudrohi.lang.selftests.str2regexstr = function () {
    try {
        var ht = new Hashtable();
        ht.put('test_passed', 't');
        var ar_failed_tests = [];
        ...
        s_needle = "|$";
        s_expected = "[|][$]";
        s = window.raudrohi.lang.str2regexstr('-^ff');
        s = window.raudrohi.lang.str2regexstr('(FF]');
        s = window.raudrohi.lang.str2regexstr('^44');
        s = window.raudrohi.lang.str2regexstr(s_needle);
        if (s !== s_expected) {
        ...
        if (0 < x_FireFox_bug_workaround) {
            ht.put('test_passed', 'f');
            ht.put('code_region_name',
                'window.raudrohi.lang.selftests.str2regexstr');
            ht.put('ar_failed_tests', ar_failed_tests);
        } // if
        return ht;
    } catch (err) {
        window.raudrohi.tmg('2b1ecaa3-5b41-4d71-a568-310261704dd7', err);
    } // catch
} // window.raudrohi.lang.selftests.str2regexstr
...
window.raudrohi.lang.ar2xseparated_list = function (ar, s_separator, s_left, s_right) {
    try {
        s_left = typeof(s_left) !== 'undefined' ? s_left : "";
        s_right = typeof(s_right) !== 'undefined' ? s_right : "";
        if (raudrohi_settings_debug_JavaScript === true) {
            window.raudrohi.base.assert_isArray(ar, 'ar',
                '2e12991e-016a-4f60-9358-310261704dd7');
            window.raudrohi.base.assert_isString(s_separator, 's_separator',
                '6358295b-885f-417a-9458-310261704dd7');
            window.raudrohi.base.assert_isString(s_left, 's_left',
                'e342ee7e-c360-4526-a158-310261704dd7');
            window.raudrohi.base.assert_isString(s_right, 's_right',
        ...
        window.raudrohi.tmg('ef99a83f-9b03-46a1-9158-310261704dd7', err);
    } // catch
} // window.raudrohi.lang.ar2xseparated_list

window.raudrohi.lang.selftests.ar2xseparated_list = function () {
    try {
        var ht = new Hashtable();
        ht.put('test_passed', 't');
        var ar_failed_tests = [];
        //---tests-start------------------
        var s = window.raudrohi.lang.ar2xseparated_list(["A", "B"], ":", "X", "Y");
        ...
        if (0 < x_FireFox_bug_workaround) {
            ht.put('test_passed', 'f');
            ht.put('code_region_name',
                'window.raudrohi.lang.selftests.ar2xseparated_list');
            ht.put('ar_failed_tests', ar_failed_tests);
        } // if
        return ht;
    } catch (err) {
        window.raudrohi.tmg('9926373e-c30e-4ab1-b348-310261704dd7', err);
    } // catch
} // window.raudrohi.lang.selftests.ar2xseparated_list
...
window.raudrohi.lang.private_code.word_wrap_fake_but_fast_get_ar_rgx =
    function (s_separator) {
        try {
            ...
            var s_rgx = window.raudrohi.lang.str2regexstr(s_separator);
            ...
            window.raudrohi.tmg('208d754c-b163-4719-b248-310261704dd7', err);
        } // catch
    } // window.raudrohi.lang.private_code.word_wrap_fake_but_fast_get_ar_rgx
...
window.raudrohi.lang.private_code.word_wrap_fake_but_fast =
    function (s_text, i_max_line_width, s_linebreak, s_separator) {
        try {
            ...
            s_out = window.raudrohi.lang.ar2xseparated_list(ar_lines, s_linebreak);
            return s_out;
        } catch (err) {
            window.raudrohi.tmg('40c65345-086d-4c2b-8348-310261704dd7', err);
        } // catch
    } // window.raudrohi.lang.private_code.word_wrap_fake_but_fast
...
window.raudrohi.lang.private_code.word_wrap_correct_but_slow =
    function (s_text, i_max_line_width, s_linebreak, s_separator) {
        try {
            ...
            window.raudrohi.tmg('d1c4dd3d-4243-454d-9348-310261704dd7', err);
        } // catch
    } // window.raudrohi.lang.private_code.word_wrap_correct_but_slow


window.raudrohi.lang.word_wrap =
    function (s_text, i_max_line_width, s_linebreak, s_separator, b_use_fake_but_fast) {
        try {
            ...
            if (raudrohi_settings_debug_JavaScript === true) {
                ...
                window.raudrohi.base.assert_isNumber(i_max_line_width, 'i_max_line_width',
                    '29530a79-7a4b-4310-b238-310261704dd7');
                window.raudrohi.base.assert_isString(s_linebreak, 's_linebreak',
                    '651b142d-8d3a-47b6-9438-310261704dd7');
                window.raudrohi.base.assert_isString(s_separator, 's_separator',
                    'ac3c7240-60b2-4c61-9138-310261704dd7');
                window.raudrohi.base.assert_isBoolean(b_use_fake_but_fast,
                    'b_use_fake_but_fast',
            ...
            window.raudrohi.tmg('082fa026-940a-435d-9338-310261704dd7', err);
        } // catch
    } // window.raudrohi.lang.word_wrap

window.raudrohi.lang.selftests.word_wrap = function () {
    try {
        var ht = new Hashtable();
        ht.put('test_passed', 't');
        var ar_failed_tests = [];
        ...
        s_hay = "A B C";
        s_expected = "AXBXC";
        s_wrapped = window.raudrohi.lang.word_wrap(s_hay, 1, "X", " ", true);
        if (s_wrapped !== s_expected) {
            ar_failed_tests.push('test 1, s_wrapped=="' + s_wrapped + '"');
        } // if
        s_hay = "A B C";
        s_expected = "A\nB\nC";
        s_wrapped = window.raudrohi.lang.word_wrap(s_hay, 2, "\n", " ", true);
        if (s_wrapped !== s_expected) {
            ar_failed_tests.push('test 2, s_wrapped=="' + s_wrapped + '"');
        } // if
        s_hay = "AA B CC";
        s_expected = "AAXBXCC";
        s_wrapped = window.raudrohi.lang.word_wrap(s_hay, 2, "X", " ", true);
        if (s_wrapped !== s_expected) {
        ...
        if (0 < x_FireFox_bug_workaround) {
            ht.put('test_passed', 'f');
            ht.put('code_region_name',
                'window.raudrohi.lang.selftests.word_wrap');
            ht.put('ar_failed_tests', ar_failed_tests);
        } // if
        return ht;
    } catch (err) {
        window.raudrohi.tmg('135e02d7-67d4-49e3-b528-310261704dd7', err);
    } // catch
} // window.raudrohi.lang.selftests.word_wrap

//-------------------------------------------------------------------------
window.raudrohi.lang.private_code.normalize_linebreaks_rgx_CR_LF =
    new RegExp("[\\r][\\n]", "g");
window.raudrohi.lang.private_code.normalize_linebreaks_rgx_CR =
    new RegExp("[\\r]", "g");
window.raudrohi.lang.private_code.normalize_linebreaks_rgx_LF =
    new RegExp("[\\n]", "g");
// Returns a string.
window.raudrohi.lang.normalize_linebreaks =
    function (s_haystack, s_resultant_linebreak) {
        try {
            ...
            if (raudrohi_settings_debug_JavaScript === true) {
                ...
                window.raudrohi.base.assert_isString(s_resultant_linebreak,
                    's_resultant_linebreak',
                    '45c5ad41-204f-4717-a628-310261704dd7');
            } // if
            var rgx_cr_lf = window.raudrohi.lang.private_code.normalize_linebreaks_rgx_CR_LF;
            var rgx_cr = window.raudrohi.lang.private_code.normalize_linebreaks_rgx_CR;
            var rgx_lf = window.raudrohi.lang.private_code.normalize_linebreaks_rgx_LF;
            var s_lf = "\n";
            ...
            window.raudrohi.tmg('19e57c21-e82e-426d-8128-310261704dd7', err);
        } // catch
    } // window.raudrohi.lang.normalize_linebreaks

window.raudrohi.lang.selftests.normalize_linebreaks = function () {
    try {
        var ht = new Hashtable();
        ht.put('test_passed', 't');
        var ar_failed_tests = [];
        //---tests-start------------------
        var s_hay = "AA\nBB\rCC\r\nDD"
        var s_normalized = window.raudrohi.lang.normalize_linebreaks(s_hay, "x");
        ...
        if (0 < x_FireFox_bug_workaround) {
            ht.put('test_passed', 'f');
            ht.put('code_region_name',
                'window.raudrohi.lang.selftests.normalize_linebreaks');
            ht.put('ar_failed_tests', ar_failed_tests);
        } // if
        return ht;
    } catch (err) {
        window.raudrohi.tmg('284bb665-c64c-4b0f-8728-310261704dd7', err);
    } // catch
} // window.raudrohi.lang.selftests.normalize_linebreaks


//-------------------------------------------------------------------------
window.raudrohi.lang.private_code.word_wrap_with_normalization_t1_rgx_S_T =
    new RegExp("[\\s\\t]", "g");
window.raudrohi.lang.word_wrap_with_normalization_t1 =
    function (s_text, i_max_line_width, s_linebreak) {
        try {
            ...
            var rgx_s_t = window.raudrohi.lang.private_code.word_wrap_with_normalization_t1_rgx_S_T;
            // The "\n" at the next line is not a mistake.
            var s_normalized = window.raudrohi.lang.normalize_linebreaks(s_text, "\n");
            var s_space = " ";
            var s1 = s_normalized.replace(rgx_s_t, s_space);
            var s_wrapped = window.raudrohi.lang.word_wrap(s1, i_max_line_width,
                s_linebreak, s_space, true);
            return s_wrapped;
        } catch (err) {
            window.raudrohi.tmg('5ee1cd52-d0b6-47fe-a318-310261704dd7', err);
        } // catch
    } // window.raudrohi.lang.word_wrap_with_normalization_t1

window.raudrohi.lang.selftests.word_wrap_with_normalization_t1 = function () {
    try {
        var ht = new Hashtable();
        ht.put('test_passed', 't');
        var ar_failed_tests = [];
        //---tests-start------------------
        var s_hay = "AA   BB\n CC\r\n D E  "
        var s_wrapped = window.raudrohi.lang.word_wrap_with_normalization_t1(s_hay,
            3, "x");
        ...
        s_hay = "AABB CC"
        s_wrapped = window.raudrohi.lang.word_wrap_with_normalization_t1(s_hay,
            2, "<br/>");
        ...
        if (0 < x_FireFox_bug_workaround) {
            ht.put('test_passed', 'f');
            ht.put('code_region_name',
                'window.raudrohi.lang.selftests.word_wrap_with_normalization_t1');
            ht.put('ar_failed_tests', ar_failed_tests);
        } // if
        return ht;
    } catch (err) {
        window.raudrohi.tmg('f3af0321-bc7a-4ab3-9418-310261704dd7', err);
    } // catch
} // window.raudrohi.lang.selftests.word_wrap_with_normalization_t1

//-------------------------------------------------------------------------
window.raudrohi.lang.get_from_ht_by_array_of_keys_index = function (i_index, ht) {
    try {
        if (raudrohi_settings_debug_JavaScript === true) {
            window.raudrohi.base.assert_isNumber(i_index, 'i_index',
                'af24165f-fb8e-4473-b308-310261704dd7');
            window.raudrohi.base.assert_isObject(ht, 'ht',
                '45c44235-d7c1-461d-a208-310261704dd7');
            if (i_index < 0) {
                window.raudrohi.tmg('21e4c95f-20f6-40bf-9308-310261704dd7',
                    "i_index==" + i_index + " < 0");
            } // if
        } // if
        var keys = ht.keys();
        ...
        if (max_index < i_index) {
            window.raudrohi.tmg('6f0b962e-24a5-4d12-9308-310261704dd7',
        ...
        window.raudrohi.tmg('9ebf61ea-35df-4027-ac08-310261704dd7', err);
    } // catch
} // window.raudrohi.lang.get_from_ht_by_array_of_keys_index

window.raudrohi.lang.selftests.get_from_ht_by_array_of_keys_index = function () {
    try {
        var ht = new Hashtable();
        ht.put('test_passed', 't');
        var ar_failed_tests = [];
        ...
        var s = window.raudrohi.lang.get_from_ht_by_array_of_keys_index(0, ht_test);
        if (s !== s_expected) {
            ar_failed_tests.push('test 1, s=="' + s + '"');
        } // if
        //---tests-end--------------------
        ...
        if (0 < x_FireFox_bug_workaround) {
            ht.put('test_passed', 'f');
            ht.put('code_region_name',
                'window.raudrohi.lang.selftests.get_from_ht_by_array_of_keys_index');
            ht.put('ar_failed_tests', ar_failed_tests);
        } // if
        return ht;
    } catch (err) {
        window.raudrohi.tmg('6445c153-f423-4882-b1f7-310261704dd7', err);
    } // catch
} // window.raudrohi.lang.selftests.get_from_ht_by_array_of_keys_index

//-------------------------------------------------------------------------
window.raudrohi.lang.cg_table_t1 = function (s_lines_HTML_code, ar_class_names) {
    try {
        var s;
        var i = 0;
        var len = null;
        if (raudrohi_settings_debug_JavaScript === true) {
            window.raudrohi.base.assert_isString(s_lines_HTML_code,
                's_lines_HTML_code',
                '947dbf35-23b8-4067-a5f7-310261704dd7');
            window.raudrohi.base.assert_isArray(ar_class_names, 'ar_class_names',
                '2164ec4f-d34c-484d-a4f7-310261704dd7');
            len = ar_class_names.length;
            for (i = 0; i < len; i++) {
                s = ar_class_names[i];
                window.raudrohi.base.assert_isString(s, 's',
        ...
        window.raudrohi.tmg('fec81346-814f-4229-95e7-310261704dd7', err);
    } // catch
} // window.raudrohi.lang.cg_table_t1

window.raudrohi.lang.selftests.cg_table_t1 = function () {
    try {
        var ht = new Hashtable();
        ht.put('test_passed', 't');
        var ar_failed_tests = [];
        //---tests-start------------------
        // Just to execute it.
        var s = window.raudrohi.lang.cg_table_t1("", ["a_class_name"]);
        if (s === (s + "none")) {
            // just to get rid of IDE warnings
            window.raudrohi.tmg('15e7c94f-acf4-4936-92e7-310261704dd7',
        ...
        if (0 < x_FireFox_bug_workaround) {
            ht.put('test_passed', 'f');
            ht.put('code_region_name',
                'window.raudrohi.lang.selftests.cg_table_t1');
            ht.put('ar_failed_tests', ar_failed_tests);
        } // if
        return ht;
    } catch (err) {
        window.raudrohi.tmg('5fb696d7-3b1b-49be-a2e7-310261704dd7', err);
    } // catch
} // window.raudrohi.lang.selftests.cg_table_t1


//-------------------------------------------------------------------------
window.raudrohi.lang.s_dec2hex = function (i_int) {
    try {
        if (raudrohi_settings_debug_JavaScript === true) {
            window.raudrohi.base.assert_isNumber(i_int, 'i_int',
        ...
        window.raudrohi.tmg('4b1cc074-6928-4e97-a3e7-310261704dd7', err);
    } // catch
} // window.raudrohi.lang.s_dec2hex

window.raudrohi.lang.selftests.s_dec2hex = function () {
    try {
        var ht = new Hashtable();
        ht.put('test_passed', 't');
        var ar_failed_tests = [];
        //---tests-start------------------
        var s = null;
        s = window.raudrohi.lang.s_dec2hex(15);
        if (s !== 'f') {
            ar_failed_tests.push('test 1, s=="' + s + '"');
        } // if
        s = window.raudrohi.lang.s_dec2hex(0);
        if (s !== '0') {
            ar_failed_tests.push('test 2, s=="' + s + '"');
        } // if
        s = window.raudrohi.lang.s_dec2hex(17);
        if (s !== '11') {
            ar_failed_tests.push('test 3, s=="' + s + '"');
        } // if
        s = window.raudrohi.lang.s_dec2hex(-18);
        if (s !== '-12') {
        ...
        if (0 < x_FireFox_bug_workaround) {
            ht.put('test_passed', 'f');
            ht.put('code_region_name',
                'window.raudrohi.lang.selftests.s_dec2hex');
            ht.put('ar_failed_tests', ar_failed_tests);
        } // if
        return ht;
    } catch (err) {
        window.raudrohi.tmg('1bafcac4-1fdf-414c-93d7-310261704dd7', err);
    } // catch
} // window.raudrohi.lang.selftests.s_dec2hex

window.raudrohi.lang.i_hex2dec = function (s_integer_in_base_16_format) {
    try {
        if (raudrohi_settings_debug_JavaScript === true) {
            window.raudrohi.base.assert_isString(s_integer_in_base_16_format,
        ...
        window.raudrohi.tmg('4f7ac803-a031-4cec-83d7-310261704dd7', err);
    } // catch
} // window.raudrohi.lang.i_hex2dec

window.raudrohi.lang.selftests.i_hex2dec = function () {
    try {
        var ht = new Hashtable();
        ht.put('test_passed', 't');
        var ar_failed_tests = [];
        //---tests-start------------------
        var i = null;
        i = window.raudrohi.lang.i_hex2dec('a');
        if (i !== 10) {
            ar_failed_tests.push('test 1, i=="' + i + '"');
        } // if
        i = window.raudrohi.lang.i_hex2dec('11');
        if (i !== 17) {
            ar_failed_tests.push('test 2, i=="' + i + '"');
        } // if
        i = window.raudrohi.lang.i_hex2dec('a0');
        if (i !== 160) {
            ar_failed_tests.push('test 3, i=="' + i + '"');
        } // if
        i = window.raudrohi.lang.i_hex2dec('-f3');
        if (i !== (-15 * 16 - 3)) {
        ...
        if (0 < x_FireFox_bug_workaround) {
            ht.put('test_passed', 'f');
            ht.put('code_region_name',
                'window.raudrohi.lang.selftests.i_hex2dec');
            ht.put('ar_failed_tests', ar_failed_tests);
        } // if
        return ht;
    } catch (err) {
        window.raudrohi.tmg('4e79639e-dc1f-4e99-84d7-310261704dd7', err);
    } // catch
} // window.raudrohi.lang.selftests.i_hex2dec
...
window.raudrohi.lang.i_number_of_digits = function (i_int, i_base) {
    try {
        if (raudrohi_settings_debug_JavaScript === true) {
            // The number of digits does not make that
            // much sense, if the number is the same
            // for 10000, 0.123, 10,11, 101,1
            window.raudrohi.lang.assert_is_a_whole_number(i_int, 'i_int',
                '05ea4627-8c47-4069-85c7-310261704dd7');
            window.raudrohi.lang.assert_is_a_whole_number(i_base, 'i_base',
        ...
        window.raudrohi.tmg('ea4d064e-72e5-47a5-92c7-310261704dd7', err);
    } // catch
} // window.raudrohi.lang.i_number_of_digits

window.raudrohi.lang.selftests.i_number_of_digits = function () {
    try {
        var ht = new Hashtable();
        ht.put('test_passed', 't');
        var ar_failed_tests = [];
        //---tests-start------------------
        var i = null;
        i = window.raudrohi.lang.i_number_of_digits(15, 10);
        if (i !== 2) {
            ar_failed_tests.push('test 1, i==' + i);
        } // if
        i = window.raudrohi.lang.i_number_of_digits(15, 16);
        if (i !== 1) {
            ar_failed_tests.push('test 2, i==' + i);
        } // if
        i = window.raudrohi.lang.i_number_of_digits(17, 16);
        if (i !== 2) {
            ar_failed_tests.push('test 3, i==' + i);
        } // if
        i = window.raudrohi.lang.i_number_of_digits(-18, 10); // the minus sign
        if (i !== 2) {
            ar_failed_tests.push('test 4, i==' + i);
        } // if
        //---tests-end--------------------
        ...
        if (0 < x_FireFox_bug_workaround) {
            ht.put('test_passed', 'f');
            ht.put('code_region_name',
                'window.raudrohi.lang.selftests.i_number_of_digits');
            ht.put('ar_failed_tests', ar_failed_tests);
        } // if
        return ht;
    } catch (err) {
        window.raudrohi.tmg('d78f8d56-7307-4484-a4c7-310261704dd7', err);
    } // catch
} // window.raudrohi.lang.selftests.i_number_of_digits
...
window.raudrohi.lang.ar_interpolate =
    function (fd_min, fd_max, i_maximum_number_of_intermittant_numbers, b_use_integer_mode) {
        try {
            if (raudrohi_settings_debug_JavaScript === true) {
                window.raudrohi.base.assert_isNumber(fd_min, 'fd_min',
                    '2b58ca72-ef6b-4a45-b7c7-310261704dd7');
                window.raudrohi.base.assert_isNumber(fd_max, 'fd_max',
            ...
            if (fd_max < fd_min) {
                window.raudrohi.tmg('4d140065-5896-43bf-a2b7-310261704dd7',
            ...
            if (i_maximum_number_of_intermittant_numbers < 0) {
                window.raudrohi.tmg('720fef39-4d22-4ea5-a357-310261704dd7',
                    'i_maximum_number_of_intermittant_numbers == ' +
            ...
            if (b_use_integer_mode === true) {
                window.raudrohi.lang.assert_is_a_whole_number(fd_min, 'fd_min',
                    '38813881-c84a-4317-9257-310261704dd7');
                window.raudrohi.lang.assert_is_a_whole_number(fd_max, 'fd_max',
            ...
            if (raudrohi_settings_debug_JavaScript === true) {
                ...
                if ((i_maximum_number_of_intermittant_numbers + 2) < i) {
                    window.raudrohi.tmg('25309bb2-5bac-4c74-bd47-310261704dd7',
                        '(i_maximum_number_of_intermittant_numbers+2)==' +
                            (i_maximum_number_of_intermittant_numbers + 2) +
                            ' < ar_out.length==' + i);
                } // if
            ...
            window.raudrohi.tmg('2d6a1afe-1d3b-4ab1-b147-310261704dd7', err);
        } // catch
    } // window.raudrohi.lang.ar_interpolate

//-------------------------------------------------------------------------
window.raudrohi.lang.assert_hashtable_contains_key =
    function (a_variable, a_variable_name, s_key, Globally_Unique_Identifier_as_string, s_optional_errmsg_suffix) {
        try {
            if (raudrohi_settings_debug_JavaScript === true) {
            ...
            s_optional_errmsg_suffix = typeof(s_optional_errmsg_suffix) !==
                'undefined' ? s_optional_errmsg_suffix : '';
            if (!window.raudrohi.base.isObject(a_variable)) {
                window.raudrohi.tmg(Globally_Unique_Identifier_as_string,
            ...
            window.raudrohi.tmg('0e9f7432-cbc5-43dd-b537-310261704dd7', err);
        } // catch
    } // window.raudrohi.lang.assert_hashtable_contains_key
...
//     } // if
//
// The window.raudrohi.lang.ar_clone_array makes a copy of the ar_in.
window.raudrohi.lang.ar_clone_array = function (ar_in) {
    try {
        if (raudrohi_settings_debug_JavaScript === true) {
        ...
        window.raudrohi.tmg('301537c4-1b65-4ef0-9d27-310261704dd7', err);
    } // catch
} // window.raudrohi.lang.ar_clone_array

//-------------------------------------------------------------------------
window.raudrohi.lang.comparison.goe.number = function (a, b) {
    try {
        var b_out = false;
        if (a <= b) {
            b_out = true;
        ...
        window.raudrohi.tmg('e1e27e2a-75a0-4947-8227-310261704dd7', err);
    } // catch
} // window.raudrohi.lang.comparison.goe.funcs.number
...
window.raudrohi.lang.comparison.equals = function (a, b, func_comparison) {
    try {
        var b_a_equals_b = (func_comparison(a, b) && func_comparison(b, a));
        return b_a_equals_b;
    } catch (err) {
        window.raudrohi.tmg('3e287dd2-11d7-48ef-8227-310261704dd7', err);
    } // catch
} // window.raudrohi.lang.comparison.equals

//-------------------------------------------------------------------------
// The window.raudrohi.lang.sort differs from the classical sort function
    ...
    function (ar_data, ar_or_func_comparison, s_mode, b_sort_in_place) {
        try {
            ...
            if (raudrohi_settings_debug_JavaScript === true) {
                ...
                window.raudrohi.base.assert_isBoolean(b_sort_in_place, 'b_sort_in_place',
            ...
            if (b_sort_in_place) {
                ...
                ar_data_out = window.raudrohi.lang.ar_clone_array(ar_data);
            } // else
            ...
            if (raudrohi_adapter_isArray(ar_or_func_comparison)) {
                ...
                if (raudrohi_adapter_isFunction(ar_or_func_comparison)) {
                    ...
                    window.raudrohi.tmg('a29eab53-5f7a-4dd2-a707-310261704dd7',
            ...
            var ar_funcs_minus_one = window.raudrohi.lang.ar_clone_array(ar_funcs);
            ...
            var i = null;
            var ar_data_out_2 = [];
            var func_equals = window.raudrohi.lang.comparison.equals; // function lookup optimization
            var func_sort = window.raudrohi.lang.sort;
            ...
            window.raudrohi.tmg('e5c66a2c-b9c0-4f3a-b307-310261704dd7', err);
        } // catch
    } // window.raudrohi.lang.sort

//-------------------------------------------------------------------------
window.raudrohi.lang.private_code.ar_scale_number_of_frames_ix_short2long =
    function (i_ar_in_len, i_number_of_frames_in_the_output_series) {
        try {
            if (raudrohi_settings_debug_JavaScript === true) {
                if (i_number_of_frames_in_the_output_series <= i_ar_in_len) {
                    window.raudrohi.tmg('5b37c412-5e56-4f73-92f6-310261704dd7',
                        'i_number_of_frames_in_the_output_series == ' +
                            i_number_of_frames_in_the_output_series + ' <= ' +
                            'i_ar_in_len == ' + i_ar_in_len);
                } // if
                if (i_ar_in_len < 2) {
                    window.raudrohi.tmg('37243059-2062-43e3-a4f6-310261704dd7',
                        'i_ar_in_len == ' + i_ar_in_len + ' < 2');
                } // if
                if (i_number_of_frames_in_the_output_series < 2) {
                    window.raudrohi.tmg('84d6795c-e202-4c8c-b3f6-310261704dd7',
                        'i_number_of_frames_in_the_output_series == ' +
            ...
            window.raudrohi.tmg('dd1f7e47-f08a-4421-83e6-310261704dd7', err);
        } // catch
    } //window.raudrohi.lang.private_code.ar_scale_number_of_frames
...
window.raudrohi.lang.ar_scale_number_of_frames =
    function (ar_input_frame_series, i_number_of_frames_in_the_output_series) {
        try {
            var i = null;
            if (raudrohi_settings_debug_JavaScript === true) {
                window.raudrohi.base.assert_isArray(ar_input_frame_series,
            ...
            if (i_ar_in_len < 1) {
                window.raudrohi.tmg('33c0c763-d2fa-4cb4-91d6-310261704dd7',
                    'ar_frames_series.length == ' + i_ar_in_len + ' < 1');
            } // if
            if (i_number_of_frames_in_the_output_series < 1) {
                window.raudrohi.tmg('a4b95904-c195-416a-bad6-310261704dd7',
                    'i_number_of_frames_in_the_output_series==' +
            ...
            if (i_ar_in_len === i_number_of_frames_in_the_output_series) {
                ar_output_series =
                    window.raudrohi.lang.ar_clone_array(ar_input_frame_series);
            ...
            if (i_ar_in_len < i_number_of_frames_in_the_output_series) {
                ...
                var ar_ix_short2long = window.raudrohi.lang.private_code.ar_scale_number_of_frames_ix_short2long(
            ...
            window.raudrohi.tmg('3d9cc4c9-2de5-45c9-95d6-310261704dd7', err);
        } // catch
    } // window.raudrohi.lang.ar_scale_number_of_frames
...
window.raudrohi.lang.s_num2s_with_leading_zero_normalization =
    function (i_or_fd_in, i_base, i_number_of_characters) {
        try {
            if (raudrohi_settings_debug_JavaScript === true) {
                window.raudrohi.base.assert_isNumber(i_or_fd_in, 'i_or_fd_in',
                ...
                if (i_base < 2) {
                    window.raudrohi.tmg('ad102057-0896-481e-a2c6-310261704dd7',
                        'i_base == ' + i_base + ' < 2');
                } // if
                if (i_number_of_characters < 1) {
                    window.raudrohi.tmg('7495502f-8a3e-433d-b1b6-310261704dd7',
                        'i_maximum_number_of_digits== ' +
            ...
            if (i_number_of_characters < i_len) {
                ...
                window.raudrohi.tmg('7d335e1b-766d-4ae7-b5b6-310261704dd7',
                    'i_number_of_characters==' + i_number_of_characters +
            ...
            window.raudrohi.tmg('49bece11-b820-4ae1-83b6-310261704dd7', err);
        } // catch
    } //window.raudrohi.lang.s_num2s_with_leading_zero_normalization
...
window.raudrohi.lang.s_escape_for_eval =
    function (s_in, b_will_be_wrapped_in_JavaScript_source_by_singlequotes) {
        try {
            ...
            window.raudrohi.tmg('23752e3f-a9df-45c3-a5a6-310261704dd7', err);
        } // catch
    } //window.raudrohi.lang.s_escape_for_eval
...
// 
window.raudrohi.lang.load_javascript_from_site_server_t1 =
    function (s_URL, func_to_execute_if_loading_complete) {
        try {
            if (raudrohi_settings_debug_JavaScript === true) {
                window.raudrohi.base.assert_isString(s_URL, 's_URL',
            ...
            window.raudrohi.tmg('16b3713d-ffb6-4997-a596-310261704dd7', err);
        } // catch
    } //window.raudrohi.lang.load_javascript_from_site_server_t1
...
window.raudrohi.lang.s_extract_substring_t1 =
    function (s_terminatorstring, s_haystack, ar_opmem) {
        try {
            ...
            if (raudrohi_settings_debug_JavaScript === true) {
                window.raudrohi.base.assert_isString(s_terminatorstring,
                    's_terminatorstring',
                    'b5dd101a-c394-4d1a-b396-310261704dd7');
                window.raudrohi.base.assert_isString(s_haystack, 's_haystack',
                    '5d4e5147-6028-414e-a486-310261704dd7');
                window.raudrohi.base.assert_isArray(ar_opmem, 'ar_opmem',
                ...
                ixs_low = ar_opmem[0];
                window.raudrohi.base.assert_isNumber(ixs_low, 'ixs_low',
                    'df687cbf-c209-434f-8586-310261704dd7');
                if (i_len_ar_opmem === 2) {
                    window.raudrohi.base.assert_isNumber(ar_opmem[1], 'ar_opmem[1]',
                        '3b499281-f2ef-4e99-8976-310261704dd7');
                } // if
            } // if
            i_len_s_terminatorstring = s_terminatorstring.length;
            window.raudrohi.base.assert_X1_isSmallerThanOrEqualTo_X2(1, '1',
                '512a6233-5cee-42ff-b376-310261704dd7',
                i_len_s_terminatorstring, 's_terminatorstring.length');
            ixs_low = ar_opmem[0];
            window.raudrohi.base.assert_X1_isSmallerThanOrEqualTo_X2(0, '0',
                '56bfe550-7dab-4f11-9476-310261704dd7',
                ixs_low, 'ar_opmem[0]');

            i_len_s_haystack = s_haystack.length;
            window.raudrohi.base.assert_X1_isSmallerThanOrEqualTo_X2(ixs_low,
            ...
            window.raudrohi.tmg('a6c4cb37-c479-4a27-9566-310261704dd7', err);
        } // catch
    } // window.raudrohi.lang.s_extract_substring_t1
