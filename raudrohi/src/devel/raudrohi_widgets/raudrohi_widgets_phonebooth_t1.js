...
window.raudrohi.widgets.g1.b_phonebooth_t1_initialization_started_at_least_once =
false;
...
// The singleton, window.raudrohi.widgets.g1.phonebooth_t1,
// facilitates the creation of such on<Event> code.
//
// It's instantiated in the library constructor.
window.raudrohi.widgets.g1.phonebooth_t1 = function (s_html_id) {
    ...
    try {
        ...
        //-----------------------------------------------------------------
        if (window.raudrohi.widgets.g1.b_phonebooth_t1_initialization_started_at_least_once !==
            false) {
            window.raudrohi.tmg('16aa123e-c82d-4752-b122-31c250705dd7',
                'The window.raudrohi.widgets.g1.phonebooth_t1 is ' +
        ...
        var pileofmethods_t1_ = new window.raudrohi.widgets.g1.pileofmethods_t1(
            self_public_, 'window.raudrohi.widgets.g1.phonebooth_t1_', s_html_id);
        var prc_ = self_public_.private_code_;
        self_public_.phone = new window.raudrohi.lang.comm.phone(
        ...
        function (s_cmd, s_data, s_destination_phone_number) {
            try {
                if (raudrohi_settings_debug_JavaScript === true) {
                    window.raudrohi.base.assert_isString(s_cmd, 's_cmd',
                        '76bc7e4f-7304-489c-b122-31c250705dd7');
                    window.raudrohi.base.assert_isString(s_data, 's_data',
                ...
                window.raudrohi.tmg('0434c083-f1c3-4478-b522-31c250705dd7', err);
            } // catch
        } // this.send_command
        ...
        // window.raudrohi.widgets.g1.phonebooth_t1.s_get_embeddable_javascript(...,
        ...
        function (s_cmd, s_data, s_destination_phone_number,
            ...
            try {
                ...
                var s_cmd_s_x = window.raudrohi.lang.s_escape_for_eval(
                    s_cmd, b_s_x_uses_singlequotes);
                var s_data_s_x = window.raudrohi.lang.s_escape_for_eval(
                    s_data, b_s_x_uses_singlequotes);
                var s_dphnn_s_x = window.raudrohi.lang.s_escape_for_eval(
                    s_destination_phone_number, b_s_x_uses_singlequotes);
                var s_x = "window.raudrohi.widgets.g1.phonebooth_t1." +
                          "send_command('" + s_cmd_s_x + "','" + s_data_s_x +
                          "','" +
                          s_dphnn_s_x + "');";
                var s_out = window.raudrohi.lang.s_escape_for_eval(s_x,
                    b_will_be_wrapped_by_singlequotes);
                return s_out;
            } catch (err) {
                window.raudrohi.tmg('51e011c2-6911-49ec-a522-31c250705dd7', err);
            } // catch
        } // this.s_get_embeddable_javascript
        ...
        window.raudrohi.tmg('5a0fc83a-3c37-4b43-b522-31c250705dd7', err);
    } // catch
} // window.raudrohi.widgets.g1.phonebooth_t1
