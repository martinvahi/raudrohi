...
window.raudrohi.widgets.g1.html_t1 = function (s_html_id) {
    try {
        ...
        var pileofmethods_t1_ = new window.raudrohi.widgets.g1.pileofmethods_t1(
            self_public_, 'window.raudrohi.widgets.g1.html_t1_', s_html_id);
        ...
        function create_containers() {
            try {
                ...
                window.raudrohi.tmg('41f8ea04-40fe-4727-9b16-01a150705dd7', err);
            } // catch
        } // create_containers
        ...
        prc_.customizable.compulsory.render_editable = function () {
            try {
                create_containers();
                window.raudrohi.base.set_innerHTML(prc_.html_id_, prc_.content_);
            } catch (err) {
                window.raudrohi.tmg('1b3fd2a3-984d-4702-8316-01a150705dd7', err);
            } // catch
        } // render_editable
        ...
        this.set_content = function (s_html) {
            try {
                ...
                window.raudrohi.tmg('24aec8a4-e8db-44e3-a656-01a150705dd7', err);
            } // catch
        } // set_content

        this.set_content_2_p = function (paragraph_text) {
            try {
                window.raudrohi.base.assert_isString(paragraph_text, 'html_text',
                ...
                window.raudrohi.tmg('4fde85c1-33ca-4dc8-8c56-01a150705dd7', err);
            } // catch
        } // set_content_t1
        ...
        this.phone.receive_phonecall = function (a_phonecall_instance) {
            try {
                ...
                switch (a_pair.a) {
                    case 'set_content':
                        a_pr3 = window.raudrohi.base.bisect(a_pair.b, '|||');
        ...
        window.raudrohi.tmg('16fa9a1d-80bf-44fd-8336-01a150705dd7', err);
    } // catch
} // window.raudrohi.widgets.g1.html_t1
